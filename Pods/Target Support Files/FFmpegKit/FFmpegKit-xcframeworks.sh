...
variant_for_slice()
{
  ...
  "Libavdevice.xcframework/xros-arm64-simulator")
    echo "simulator"
    ;;
  "libshaderccombined.xcframework/ios-arm64")
    echo ""
    ;;
  "libshaderccombined.xcframework/ios-arm64_x86_64-maccatalyst")
    echo "maccatalyst"
    ;;
  "libshaderccombined.xcframework/ios-arm64_x86_64-simulator")
    echo "simulator"
    ;;
  "libshaderccombined.xcframework/macos-arm64_x86_64")
    echo ""
    ;;
  "libshaderccombined.xcframework/tvos-arm64_arm64e")
    echo ""
    ;;
  "libshaderccombined.xcframework/tvos-arm64_x86_64-simulator")
    echo "simulator"
    ;;
  "libshaderccombined.xcframework/xros-arm64")
    echo ""
    ;;
  "libshaderccombined.xcframework/xros-arm64-simulator")
    echo "simulator"
    ;;
...
install_xcframework "${PODS_ROOT}/../../FFmpegKit/Sources/libshaderccombined.xcframework" "FFmpegKit/FFmpegKit" "framework" "ios-arm64" "ios-arm64_x86_64-maccatalyst" "ios-arm64_x86_64-simulator"
