...
open class SwiftyOnboardOverlay: UIView {
    ...
    func setUp() {
        ...
        pageControl.bottomAnchor.constraint(equalTo: margin.bottomAnchor, constant: -50).isActive = true
        ...
        continueButton.leftAnchor.constraint(equalTo: margin.leftAnchor, constant: 50).isActive = true
        continueButton.rightAnchor.constraint(equalTo: margin.rightAnchor, constant: -50).isActive = true
