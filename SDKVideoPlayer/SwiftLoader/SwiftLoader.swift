...
public class SwiftLoader: UIView {
    ...
    public class func show(view: UIView?,title: String?, animated : Bool) {
        ...
        if let v = view {
            ...
            NotificationCenter.default.addObserver(loader, selector: #selector(loader.didBecomeActive(notification:)), name: UIApplication.didBecomeActiveNotification, object: nil)
...
//            currentWindow.rootViewController?.view.addSubview(loader)
    ...
    class SwiftLoadingView : UIView {
        ...
        private var LayerImage:UIImageView = {
...
//            ])
        ...
        func start() {
            ...
            LayerImage.layer.add(rotationAnimation, forKey: "rotationAnimation")
        }
        ...
        func stop() {
            ...
            LayerImage.layer.removeAllAnimations()
    ...
    public struct Config {
        ...
        /// Color of title text
        public var titleTextColor = UIColor.MainColor()
